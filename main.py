...
def button():
	BUTTON=[[InlineKeyboardButton(text="Sahibim ",url="t.me/memokra")]]
	BUTTON+=[[InlineKeyboardButton(text="Bağış",url="t.me/sohbetgoxkurucu")]]
